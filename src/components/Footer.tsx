  ...
  return (
    <footer className="relative z-10 border-t border-white/[0.06] mt-32">
      <div className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-10">
          <div className="col-span-2">
            ...
            <p className="mt-5 text-sm text-white/50 max-w-xs">
              ...
              automation platforms for teams building the future.
            </p>
        ...
        {/* Big wordmark */}
        <div className="mt-16 select-none -mx-6 overflow-hidden">
          <div className="text-[clamp(4rem,18vw,14rem)] leading-none font-bold tracking-tighter text-white/[0.07] text-center transition-all duration-700 hover:text-white/[0.15] cursor-default whitespace-nowrap px-2">
            SPACEGREY
          </div>
        </div>
      </div>
